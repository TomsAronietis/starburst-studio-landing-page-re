        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mb-6 flex flex-col items-center">
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-black leading-[1.2] md:leading-[1.1] mb-3 max-w-4xl">
              Look like a <span className="bg-[#B89B4F] text-white px-2 py-1 rounded">luxury top-producer</span>, without the headache.
            </h1>
          ...
          <p className="text-xl md:text-2xl text-black leading-relaxed mb-6 max-w-3xl font-light">
